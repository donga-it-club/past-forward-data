...
- (ver2) 1차 프로젝트 기간: 2024-05-04 ~ 2024-08-30
<br>

## 3. ver1까지의 프로젝트 진행 내용
### 사용자 발생 전(서비스 배포 전) 측정 전략 수립 및 데이터 분석 설계를 진행
- 측정 전략 수립
...
- GA4와 웹사이트 연결 작업
  ...
  - 상세한 관리 시트를 작성하여 설정 과정의 체계적 관리를 진행
  - GA4 연결 관리 시트 링크: [GA4 이벤트(태그 및 트리거) 연결 관리](https://docs.google.com/spreadsheets/d/14MOWROUp9OW6DUsmbUVyK9VuWGpBPQ2UsueqGhLjG64/edit?usp=sharing)
### 사용자 데이터를 바탕으로 분석 보고서를 작성
- GA4를 활용하여 수집한 사용자 데이터를 바탕으로 웹사이트의 사용자 행동 패턴, 이탈률, 평균 참여 시간, 트래픽 소스 등을 분석
- 사용자 수 감소의 원인, 트래픽 유입 경로 및 각 페이지의 이탈률을 도출하여 웹사이트의 개선 방향을 제시
<br>
